...
public class StatusController {
    ...
    ApiResponse<StatusResponse> updateStatus(
            @PathVariable("name") String name, @RequestBody StatusRequest statusRequest) {
        return ApiResponse.<StatusResponse>builder()
    ...
    ApiResponse<String> deleteStatus(@PathVariable("name") String name) {
        ...
        return ApiResponse.<String>builder().result("Status deleted").build();
    }
}
